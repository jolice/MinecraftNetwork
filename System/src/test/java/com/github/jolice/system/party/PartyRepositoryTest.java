...
import com.github.jolice.system.party.result.CreateResult;
import com.github.jolice.system.party.result.InviteResult;
import com.github.jolice.system.party.result.RemoveResult;
...
public class PartyRepositoryTest {
    ...
    @Test
    public void create() {
        Assert.assertEquals(CreateResult.CREATED, partyRepository.create(OWNER));
    }
    ...
    public void acceptWithoutInvitation() {
        partyRepository.create(OWNER);
        Assert.assertEquals(AcceptResult.NO_INVITATION, partyRepository.accept(OWNER, "player"));
    }
    ...
    public void acceptWhenPartyOwner() {
        ...
        Assert.assertEquals(InviteResult.INVITED, partyRepository.invite("target_owner", OWNER, 500));
